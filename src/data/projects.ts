...
export const projects: ProjectData[] = [
  ...
  {
  slug: "cofounder-matching-platform",
  title: "CoFinder: Co-founder Matching Platform",
  description: "A full-stack platform to connect founders and collaborators based on shared skills and interests.",
  tags: ["Full-Stack", "Recommendation Systems", "Web Development"],
  year: "2023",
  color: "hsl(var(--accent))",
  longDescription:
    "Built a full-stack platform to help founders and collaborators find each other based on complementary expertise and interests. Focused on designing efficient matching logic and building a system that supports real user interaction, product listings, and evolving features like cart functionality, cookies and recommendation system.",
  features: [
    "Dynamic co-founder and collaborator matching based on skills and interests",
    "Custom recommendation logic for efficient and relevant connections",
    "Product listing system with database storage and discounted pricing display",
    "Add-to-cart functionality",
    "Post creation and update capabilities",
    "User interaction via email notifications",
  ],
  techStack: [
    "AngularJS",
    "Node.js",
  ...
  screenshots: [
    ...
    { caption: "Backend-driven recommendation flow" },
  ],
},
  {
